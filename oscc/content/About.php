...
<p>You should go and <a href="?page=Edit_Site">do that now</a>, so you can set a password! If you set it to <code>default</code>, like it is now, then everyone who visits the site is logged in.